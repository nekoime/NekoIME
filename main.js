...
(function() {
  var analyzer, exporter_google, exporter_sogou, exporter_sunpinyin, spider_moegirlwiki, transcoder_pinyin;
  ...
  setImmediate(function() {
    return spider_moegirlwiki.start(function(from, text, type, weight) {
      ...
      return analyzer.analyze(null, text, type, weight, function(new_words, updated_words) {
        ...
        return exporter_sunpinyin.update(new_words, updated_words);
      });
    });
  });
